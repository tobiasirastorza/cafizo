...
import {
  useEditRoutineModal,
  type EditRoutineInitialData,
} from "@/hooks/useEditRoutineModal";
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-foreground/20 p-4">
          ...
          >
            <div className="sticky top-0 z-20 border-b border-border-subtle bg-background-card/95 p-5 backdrop-blur-sm">
              <h2 className="text-xl font-semibold text-foreground">{t("edit.title")}</h2>
              <p className="mt-2 text-sm text-foreground-secondary">{t("edit.subtitle")}</p>
            </div>
            ...
            <div className="flex items-center justify-end gap-3 border-t border-border-subtle p-5">
              ...
              >
                {isSubmitting ? t("edit.actions.saving") : t("edit.actions.submit")}
              </button>
            </div>
          </div>
        </div>
